...
<body>
	...
	<main>
		<div class="main">
			<div>
				...
				<div class="bg-dark sigonosigo" id="confirma" style="display:none;">
                	...
                	<button class="btn btn-danger" id="si">Sí</butto>
    	...
    	<center>
			...
			<h2>TURNOS</h2>
        	<form action="./agendar.php" method="POST" id="formulario_turno">
				<input type="date" id="fecha" name="fecha" placeholder="Fecha">
        		<input type="time" id="hora" name="hora" placeholder="Hora">
				<input class="btn btn-light" type="number" id="cupos" name="cupos" placeholder="Cantidad de turnos">
	            <button class="btn btn-success" type="submit">Sumar turno</button>
    	    </form>

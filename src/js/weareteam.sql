...
CREATE TABLE `calificaciones_diarias` (
  `id` int(11) NOT NULL,
  `id_alumno` int(11) DEFAULT NULL,
...
ALTER TABLE `calificaciones_diarias`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_alumno` (`id_alumno`),
  ADD KEY `id_materia` (`id_materia`);

  ALTER TABLE `calificaciones_diarias`
  ADD CONSTRAINT `calificaciones_diarias_ibfk_1` FOREIGN KEY (`id_alumno`) REFERENCES `alumnos` (`id`),
  ADD CONSTRAINT `calificaciones_diarias_ibfk_2` FOREIGN KEY (`id_materia`) REFERENCES `materias` (`id`);
COMMIT;
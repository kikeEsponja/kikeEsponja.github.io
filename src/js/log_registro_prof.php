...
if($_POST){
	...
	$chequeo = "SELECT * FROM profes WHERE correo = '$email'";
	$result = mysqli_query($conn, $chequeo);

	if(mysqli_num_rows($result) > 0){
		echo "<center>";
		echo "<h2 class='text-light'>Usuario existente</h2><br><br><a class='btn btn-warning' href='../../admin/registro_prof.php'>volver</a>";
		echo "</center>";
	}else{

<?php
	...
	if(isset($_SESSION['nombre']) && isset($_SESSION['correo'])){
		...
		//$chequeoCalificaciones = "SELECT calificacion FROM calificaciones_diarias WHERE id = $idAlumno";
		//$resultCalificaciones = mysqli_query($conn, $chequeoCalificaciones);

		//$calificacionesText = "Sin calificaciones registradas";
		//if(mysqli_num_rows($resultCalificaciones) > 0){
			//$rowCalificaciones = mysqli_fetch_assoc($resultCalificaciones);
			//$calificacionesText = "Calificación: " . $rowCalificaciones['calificacion'];
		//}
